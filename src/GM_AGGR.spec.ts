...
const testAggregation: Macro<any> = (
  t: ExecutionContext,
  { table_range_with_headers, aggregation_prop, geography, expectedOutput }
) => {
  const output = GM_AGGR(table_range_with_headers, aggregation_prop, geography);
...
[
  ...
  },
  {
    ...
    expectedOutput: [
      ...
      ["africa", "Africa", 1911, 1, 400, 7, "", 68, "", ""],
      ["africa", "Africa", 1913, 1, "", 54, 3574, 4, "", 20000],
      ["americas", "The Americas", 1906, 2, "", 3, "", "", 76, 4],
      ["americas", "The Americas", 1908, 2, 7300, 2345, 66, "", 7, 5],
      ["americas", "The Americas", 1910, 1, 12000, 345, 666, 68, "", 578],
      ...
      ["asia", "Asia", 1910, 2, 6, "", 666, 56, 756, 6],
      ["asia", "Asia", 1912, 1, 1200, 66, 90000, 8, 90000, 30000],
      ["europe", "Europe", 1906, 1, 666, 666, 7, "", 6, 6750],
      ["europe", "Europe", 1907, 1, 1000, 6666, 57, 67, 6, 67],
      ["europe", "Europe", 1908, 1, 24, 5, 357, 68, "", 8],
      ["europe", "Europe", 1909, 1, 700, 7, 666, 6, 767, 46],
      ["europe", "Europe", 1912, 1, "", "", 666, 546, 57, 45]
    ]
  },
  {
    table_range_with_headers: [
  ...
  },
  {
    ...
    expectedOutput: [
      ...
      ["Low income", "Low income", 1911, 1, 400, 7, "", 68, "", ""],
      [
        "Lower middle income",
        "Lower middle income",
        1910,
