...
*Defined in [GM_AGGR.ts:27](https://github.com/Gapminder/gsheets-gm-functions/blob/95be916/src/GM_AGGR.ts#L27)*
...
▸ **GM_DATA**(column_range_with_headers: *`string`[][]*, prop: *`string`*): `string`[][]

*Defined in [GM_DATA.ts:10](https://github.com/Gapminder/gsheets-gm-functions/blob/95be916/src/GM_DATA.ts#L10)*
...
*Defined in [GM_ID.ts:10](https://github.com/Gapminder/gsheets-gm-functions/blob/95be916/src/GM_ID.ts#L10)*
...
*Defined in [GM_INTERPOLATE.ts:23](https://github.com/Gapminder/gsheets-gm-functions/blob/95be916/src/GM_INTERPOLATE.ts#L23)*
...
*Defined in [GM_NAME.ts:10](https://github.com/Gapminder/gsheets-gm-functions/blob/95be916/src/GM_NAME.ts#L10)*
